...
class __TwigTemplate_c45e1af66f904d2ddd720716a447e83cb863187d349d7591c25b38ec7492efc4 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["mi"]) {
            ...
            echo "\"";
            // line 11
            echo ((((0 === twig_compare(($context["current_index"] ?? null), $context["mi"])) || (0 === twig_compare(($context["current_index"] ?? null), ($context["mi"] + 1))))) ? (" disabled=\"disabled\"") : (""));
            echo ">
            ";
            // line 12
...
";
    ...
    {
        return new Source("", "columns_definitions/move_column.twig", "C:\\Users\\FamiliaNatelloMedina\\Documents\\UNLu\\BasedeDatosMasivas\\SoftWare\\phpMyAdmin-5.0.3-all-languages\\templates\\columns_definitions\\move_column.twig");
    }
}
