...
class __TwigTemplate_f424a66c14f499bc82945216af7ee0604f9d9acca96ea1863656008f4a62ba92 extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 2
        if (((((0 === twig_compare(($context["type"] ?? null), "text")) || (0 === twig_compare(        // line 3
($context["type"] ?? null), "blob"))) || (0 === twig_compare(        // line 4
...
";
    ...
    {
        return new Source("", "table/structure/action_row_in_structure_table.twig", "C:\\Users\\FamiliaNatelloMedina\\Documents\\UNLu\\BasedeDatosMasivas\\SoftWare\\phpMyAdmin-5.0.3-all-languages\\templates\\table\\structure\\action_row_in_structure_table.twig");
    }
}
