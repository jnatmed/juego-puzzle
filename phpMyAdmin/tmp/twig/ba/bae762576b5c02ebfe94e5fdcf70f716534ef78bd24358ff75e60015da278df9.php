...
class __TwigTemplate_227b3df46c52fcd274e1127efa1f7df7248303192f0dea0d44e0ff69b93cc06b extends Template
{
    private $source;
    private $macros = [];
...
($context["pma_theme_image"] ?? null)]));
    ...
    <form id=\"import_file_form\"
        ...
        ";
        // line 27
        if ((0 === twig_compare(($context["import_type"] ?? null), "server"))) {
            // line 28
            echo "            ";
...
($context["import_type"] ?? null), "database"))) {
        ...
        if ((0 === twig_compare(($context["import_type"] ?? null), "server"))) {
            ...
            // line 41
            echo "                ";
        } elseif ((0 === twig_compare(($context["import_type"] ?? null), "database"))) {
            // line 42
            echo "                    ";
        ...
        if (($context["is_encoding_supported"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["charset"]) {
                ...
                echo "\"
                                ";
                // line 102
                if (((twig_test_empty(($context["import_charset"] ?? null)) && (0 === twig_compare($context["charset"], "utf-8"))) || (0 === twig_compare(                // line 103
$context["charset"], ($context["import_charset"] ?? null))))) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["charset"]) {
                ...
                echo "\"";
                // line 115
                echo (((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["charset"], "name", [], "any", false, false, false, 115), "utf8"))) ? (" selected") : (""));
                echo ">";
                // line 116
...
";
    ...
    {
        return new Source("", "display/import/import.twig", "C:\\Users\\FamiliaNatelloMedina\\Documents\\UNLu\\BasedeDatosMasivas\\SoftWare\\phpMyAdmin-5.0.3-all-languages\\templates\\display\\import\\import.twig");
    }
}
