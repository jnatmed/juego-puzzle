...
class __TwigTemplate_67da87f5fe8eebd34986c66631ba1991f2361237edffa26bc066ce0415abb781 extends Template
{
    private $source;
    private $macros = [];
    ...
    <ul>
        ...
        // line 6
        echo ((( !(null === ($context["allrows"] ?? null)) && (0 === twig_compare(($context["allrows"] ?? null), 0)))) ? (" checked") : (""));
        echo ">
...
($context["unlim_num_rows"] ?? null)) && (0 !== twig_compare(($context["unlim_num_rows"] ?? null), 0)))) {
        ...
        // line 30
        echo ((((null === ($context["allrows"] ?? null)) || (0 === twig_compare(($context["allrows"] ?? null), 1)))) ? (" checked") : (""));
        echo ">
...
";
    ...
    {
        return new Source("", "display/export/options_rows.twig", "C:\\Users\\FamiliaNatelloMedina\\Documents\\UNLu\\ProgramacionWeb\\phpMyAdmin\\templates\\display\\export\\options_rows.twig");
    }
}
